...
#define STRING_CONFIG_H_AUTHOR "BIQU KOSSEL" // Who made the changes.
#define BIGTREE "http://bigtreetech.com"
#define SHOW_BOOTSCREEN
//#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
//#define STRING_SPLASH_LINE2 WEBSITE_URL         // will be shown during bootup in line 

#define STRING_SPLASH_LINE1 "2017/1/20"
#define STRING_SPLASH_LINE2 BIGTREE         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "BIQU"
...
#define DELTA_DIAGONAL_ROD 337.59// mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 203.11// mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET  25.25// mm

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 11// mm
...
/**
   ...
   Override with M203
                                        X, Y, Z, E0 [, E1[, E2[, E3]]]
*/
#define DEFAULT_MAX_FEEDRATE          { 800, 800, 800, 25 }
...
/**
   ...
   Override with M201
                                        X, Y, Z, E0 [, E1[, E2[, E3]]]
*/
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 1500, 1000 }
...
#define Z_PROBE_ALLEN_KEY_STOW_3_Z 10.0
...
#define MANUAL_Z_HOME_POS 310// Distance between the nozzle to printbed after homing
